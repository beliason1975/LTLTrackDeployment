		SELECT
			...
			'23277308' AS [PickupRequestNbr],  --2
			o.coyote_pu_no,
		...
		WHERE --o.operational_status = 'PICK' AND
			(o.coyote_pu_no = '232                      77308' OR o.id = '23277308')
