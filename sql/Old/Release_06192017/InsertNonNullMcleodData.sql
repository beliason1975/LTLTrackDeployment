...
from [OFFSQLENTD01].[McLeodData_LTL].[dbo].orders o
    left join  [OFFSQLENTD01].[McLeodData_LTL].[dbo].[stop]         orig on orig.id = o.shipper_stop_id    and
                                      orig.company_id = o.company_id and
                                      orig.stop_type = 'PU'
    left join  [OFFSQLENTD01].[McLeodData_LTL].[dbo].[stop]         con  on con.id = o.consignee_stop_id   and
                                      con.company_id = o.company_id  and
                                      con.stop_type = 'SO'
    left join [OFFSQLENTD01].[McLeodData_LTL].[dbo].freight_group  fg   on fg.lme_order_id = o.id         and
