...
/****** Object:  StoredProcedure [dbo].[GetCoyoteProStatuses]    Script Date: 06/19/2017 2:11:58 AM ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GetCoyoteProStatuses]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[GetCoyoteProStatuses] AS'
END
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[GetCoyoteProStatuses] (
	@pProNumber integer,
	@webSite bit
)
AS
