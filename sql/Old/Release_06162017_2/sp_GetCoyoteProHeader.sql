...
/****** Object:  StoredProcedure [dbo].[GetCoyoteProHeader]    Script Date: 06/22/2017 5:53:18 PM ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GetCoyoteProHeader]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[GetCoyoteProHeader] AS'
END
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[GetCoyoteProHeader] (
	@pProNumber integer,
	@webSite bit
)
AS
