...
set Pro                =     T.Pro,
    ...
    BOL                =     T.BOL,
    PONumber           =     T.PONumber,
    ApptDate           =     ISNULL(CAST(CAST(T.ApptDate AS VARCHAR(10)) AS DATE), CAST(CAST(w.ApptDate AS VARCHAR(10)) AS DATE)),
    EstDeliveryDate       =  ISNULL(CAST(CAST(T.EstDeliveryDate AS VARCHAR(10)) AS DATE), CAST(CAST(w.EstDeliveryDate AS VARCHAR(10)) AS DATE)),
    DeliveredDate       =    ISNULL(CASE WHEN T.DeliveredDate <> 0 THEN CAST(CAST(T.DeliveredDate AS VARCHAR(10)) AS DATE) ELSE NULL END, CAST(CAST(w.DeliveredDate AS VARCHAR(10)) AS DATE))
from (
select *
