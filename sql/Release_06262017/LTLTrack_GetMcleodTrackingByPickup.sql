...
/****** Object:  StoredProcedure [dbo].[LTLTrack_GetMcleodTrackingByPickup]    Script Date: 06/23/2017 1:27:10 AM ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[LTLTrack_GetMcleodTrackingByPickup]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[LTLTrack_GetMcleodTrackingByPickup] AS' 
END
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[LTLTrack_GetMcleodTrackingByPickup]
	@PickupNbr CHAR(8)
AS
BEGIN
