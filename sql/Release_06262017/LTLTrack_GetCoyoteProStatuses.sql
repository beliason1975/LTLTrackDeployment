...
/****** Object:  StoredProcedure [dbo].[LTLTrack_GetCoyoteProStatuses]    Script Date: 06/23/2017 1:26:56 AM ******/
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[LTLTrack_GetCoyoteProStatuses]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[LTLTrack_GetCoyoteProStatuses] AS' 
END
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[LTLTrack_GetCoyoteProStatuses] (
	@pProNumber integer, 
	@webSite bit
)
AS
